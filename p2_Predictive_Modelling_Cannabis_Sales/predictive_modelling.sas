...
proc import file="/home/u63049952/BAN210/Project/ban210dev1.csv" out=dev_data 
		dbms=csv Replace;
	delimiter=',';
	***	TAB - delimiter	;
	GUESSINGROWS=20;
...
filename data '/home/u63049952/BAN210/Project/metadata.xlsx';
...
footnote1"1. ECYEDUHSCE=High School Certificate Or Equivalent";
footnote2"2.ECYPOWNFIX=No Fixed Workplace Address";
footnote3"3.HSTA001S=Spent on - Tobacco products and alcoholic beverages";
footnote4"4.HSHC001=Spent on - Health care";
footnote5"5.HSRE001=Spent on - Recreation";
ods proctitle off;
...
proc print data=meta_data;
	where variable in ('DEPVAR7', 'ECYPOWNFIX', 'ECYEDUHSCE', 'HSRE001', 
		'HSTA001S', 'HSHC001');
...
/* HSRE001	Spent on - Recreation */
/* HSHC001	Spent on - Health care */
/* run; */
/* ************************************ - 3 - *************************************************** */
proc contents data=dev_data;
run;

/* LS  */
/* SG */
/* DensityClusterCode5_lbl */
/* PRCDDA */
...
PROC CORR DATA=analytical_file RANK OUT=corr_data  /*noprint*/;
	VAR TOT__SPENT7 ECYBASHPOP CNBBAS19P CNBBAS1934 CNBBAS35P ECYHTA2529 
		ECYHTA3034 ECYHTA5559 ECYHTA6064 ECYHTA6569 ECYHTA7074 ECYMTN2534 ECYMTN3544 
		ECYMTN4554 ECYHSZ1PER ECYHSZ2PER ECYMARM ECYMARCL ECYMARSING ECYMARDIV 
		ECYMARWID ECYCFSLP ECYCHAKIDS ECYTENOWN ECYPOC17P ECYSTYSING ECYSTYSEMI 
		ECYSTYAPT ECYSTYAPU5 ECYCDOIC ECYEDUHSCE ECYEDUUD ECYACTINLF ECYACTUR 
		ECYOCCMGMT ECYOCCSCND ECYINDMINE ECYINDCSTR ECYINDMANU ECYINDWHOL ECYINDRETL 
		ECYINDINFO ECYINDFINA ECYINDREAL ECYINDPROF ECYINDMGMT ECYINDADMN ECYINDEDUC 
		ECYINDHLTH ECYINDARTS ECYINDOSER ECYINDPUBL ECYPOWHOME ECYPOWOSCA ECYPOWNFIX 
		ECYTRADRIV ECYTRAPSGR ECYTRAPUBL ECYTRAWALK ECYTRABIKE ECYRELCHR ECYRELCATH 
		ECYHOMFREN ECYHOMPANJ ECYHOMCHIN ECYHOMUKRA ECYTIMSA ECYTIMSAM ECYPIMNI 
		WSIN100_P WSWORTHV WSCARDSB WSD2AR HSHC001S HSRE001S HSTA001S HSGC001S 
		HSSH011 HSSH014 HSRM014 HSSH036A HSSH037A HSSH037B HSFD990 HSFD991 HSCS013 
		HSCS007 HSCS008 HSHC001 HSHC002 HSHC003 HSHC004A HSHC004B HSHC007 HSHE012 
		HSTR058 HSTR034 HSTR050 HSRE001 HSRE040 HSRE042 HSRE052 HSRE061 HSRE063 
		HSRE006 HSRE011 HSRE021 HSRV001B HSCL001 HSCM001D HSCM001F HSCL011 HSED005 
		HSED006 HSRO001 HSRO002 HSTA002A HSTA002B HSTA005 HSTA006 HSGC001 HSMG008 
		HSWH015 SV00002 SV00005 SV00011 SV00012 SV00021 SV00023 SV00025 SV00028 
		SV00029 SV00030 SV00035 SV00036 SV00037 SV00038 SV00041 SV00043 SV00044 
		SV00058 SV00061 SV00064 SV00066 SV00070 SV00074 SV00077 SV00079 SV00271 
		SV00086 SV00091 SV00093;
	with DEPVAR7;
run;
...
proc import file="/home/u63049952/BAN210/Project/ban210val1.csv" out=val_data 
		dbms=csv Replace;
	delimiter=',';
	***	TAB - delimiter	;
	GUESSINGROWS=20;
...
/*  */
/* PROC HPSPLIT DATA=val_data nodes plots=all maxdepth=5 maxbranch=3; */
/*   */
/* MODEL depvar7=  */
/* HSRE011 */
/* HSTA001S */
